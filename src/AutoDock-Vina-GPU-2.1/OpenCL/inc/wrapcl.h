...
// Returns the number of GPU devices available on the detected platform
...
void SetupQueue(cl_command_queue* queue, cl_context context, cl_device_id* devices, int device_index = 0);
